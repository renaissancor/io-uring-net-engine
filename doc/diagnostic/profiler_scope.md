...
`doc/sds/cstr_hash_map.md` for the key contract and
`doc/sds/malloc_vector.md` for the record-list contract. This buys us
...
4. **Thread-local profiler shutdown order.** `thread_local` destruction
   ...
   `doc/network/listener_and_service.md`).
