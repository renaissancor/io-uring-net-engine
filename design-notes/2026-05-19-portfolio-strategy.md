...
1. **Documented architecture decisions.** The design docs in `doc/` and `doc/` ARE the portfolio. Most candidates can't articulate this stuff at this level. Make sure the writing shows up prominently.
